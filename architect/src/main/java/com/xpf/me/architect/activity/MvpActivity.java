package com.xpf.me.architect.activity;

import android.os.Bundle;
import android.support.annotation.NonNull;
import android.support.v7.app.AppCompatActivity;

import com.xpf.me.architect.delegate.ActivityDelegate;
import com.xpf.me.architect.delegate.ActivityDelegateCallback;
import com.xpf.me.architect.delegate.IActivityDelegate;
 ...
 */
public abstract class MvpActivity<V extends IView, P extends IPresenter<V>> extends AppCompatActivity implements IView, ActivityDelegateCallback<V, P> {

    protected P presenter;

    protected boolean retainInstance;

    protected IActivityDelegate mvpDelegate;
     ...
     * </p>
     *
     * @return {@link com.xpf.me.architect.delegate.ActivityDelegate}
     */
    @NonNull
    protected IActivityDelegate<V, P> getMvpDelegate() {
        if (mvpDelegate == null) {
            mvpDelegate = new ActivityDelegate(this);
        }
